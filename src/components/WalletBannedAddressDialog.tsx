...
import { Callout, AlertDialog as themes_AlertDialog } from "@radix-ui/themes"

export function WalletBannedAddressDialog({
  open,
}: {
  open: boolean
}) {
    ...
    <>
      ...
      <div className="flex flex-col items-center text-center mb-6">
        ...
        <AlertDialog.Description className="mt-2 text-gray-11">
          For your safety, your wallet address is blocked from using this app.
