...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <div className="relative isolate flex min-h-svh w-full bg-gray-800 p-2">
      <main className="flex-1 flex flex-col lg:grid lg:grid-cols-2 bg-white rounded-3xl overflow-hidden">
        <div className="flex-1 px-4 py-12 md:px-6 flex flex-col items-center justify-center">
          <div className="max-w-md w-full">
            <Link href="/" className="inline-block mb-8 md:mb-12">
              ...
              <NearIntentsLogoIcon className="h-3 md:h-4 text-black" />
            </Link>
