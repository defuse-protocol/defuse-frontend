...
export const NEXT_PUBLIC_COIN_PRICES_API_BASE_URL =
  process.env.NEXT_PUBLIC_COIN_PRICES_API_BASE_URL
export const NEXT_PUBLIC_COIN_PRICES_API_KEY =
  process.env.NEXT_PUBLIC_COIN_PRICES_API_KEY
