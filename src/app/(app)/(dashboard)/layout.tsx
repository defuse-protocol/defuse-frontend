...
const DashboardLayout = ({ children }: { children: ReactNode }) => (
  <div className="relative isolate flex min-h-svh w-full bg-gray-25 lg:bg-gray-800">
    ...
    {/* Content */}
    <div className="relative flex flex-1 flex-col lg:pb-2 lg:min-w-0 lg:pt-2 lg:pr-2 lg:pl-74 gap-2">
      <SystemStatus showOperationalStatus={false} />
      <NetworkOutageNotification />

      <main className="relative grow p-4 sm:p-6 lg:rounded-3xl lg:bg-gray-25 lg:p-10">
