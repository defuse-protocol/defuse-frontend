...
export default function MaintenancePage() {
  return (
    <div className="bg-surface-card flex flex-col items-center justify-center px-4 flex-1">
      <div className="max-w-5xl w-full flex flex-col items-center justify-center">
        ...
        <p className="text-fg-secondary mt-4 md:mt-6 text-lg md:text-xl text-center">
